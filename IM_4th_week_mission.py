...
character1_name = '룰루' ## character1의 name 정의
character1_attack = 47 ## character1의 attack 정의
character1_health = 525 ## character1의 health 정의
character1_speed = 330 ## character1의 speed 정의
...
character2_name = '티모'  ## character1의 name 정의
character2_attack = 54  ## character1의 attack 정의
character2_health = 528  ## character1의 health 정의
character2_speed = 330  ## character1의 speed 정의
...
# character3 만들어주기(정보 할당)
character3_name = '모르가나'  ## character1의 name 정의
character3_attack = 55.5  ## character1의 attack 정의
character3_health = 559  ## character1의 health 정의
character3_speed = 335  ## character1의 speed 정의
...
class Character:                 # Character class 정의해주기
    def __init__(self, name, attack, health, speed):         # 생성자 정의 - name, attack, health, speed 입력
        ...
        self.health = health     # self.health
    ...
    def character_info(self):# character_info() 메서드 정의
        ...
        print(f'기본 공격력: {self.attack}')   # attack 출력
        print(f'기본 체력: {self.health}')   # health 출력
        print(f'기본 속력: {self.speed}')   # speed 출력
        print()

character1 = Character('룰루', 47, 525, 330)
character1.character_info()

character1 = Character('티모', 54, 528, 330)
character1.character_info()

character1 = Character('모르가나', 55.5, 559, 335)
character1.character_info()
'''

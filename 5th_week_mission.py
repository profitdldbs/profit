...
if sub >= 1000 :
    print('수익 창출을 할 수 있습니다.')
else:
    print('수익 창출을 할 수 없습니다.')
'''
...
youtuber = ['먹어볼래TryToEat', '로보티즈노원', '사나고Sanago', '긱블', '휘용', '퓨리파이', '김도연TV']
print(youtuber)
'''
## 리스트 제어하기1: 데이터 추가
...
## 연습문제>> 내가 가장 좋아하는 유튜버의 이름을 2번째로 좋아하는 유튜버의 이름으로 바꿔보자
<명령입력>
print(youtuber)

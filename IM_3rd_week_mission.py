...
## ※ 결과 확인이 중요!!
'''
numbers = 100, 546, 896, 10, 777, 1, 80, 3, 1
...
print(numbers.count(1))         # .count(): 입력한 숫자가 튜플에 몇 개 있는지 세어주는 함수(메서드)
...
print(youtuber['찬사'])     # ()안에 값에 접근하는 문장 넣어주기
...
del youtuber['로보티즈노원']                             # 딕셔너리 값 지우기 명령 수행
print(youtuber)
...
print(type(youtuber.keys()))     # .keys(): 원소가 key로 이루어진 데이터를 포함하는 list를 반환하는 함수
